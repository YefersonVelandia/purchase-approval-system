  ...
  useEffect(() => {
    ...
    approvalService
      ...
      .then((res) => {
        ...
        navigate(`/approvals/approve/otp?solicitud_id=${encodeURIComponent(solicitudId)}&expiresAt=${encodeURIComponent(res.otpExpiresAt)}&otpCode=${encodeURIComponent(res.otpCode)}`, {
          replace: true,
        });
      })
      .catch(() => {
